              ...
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form action="{{ route('admin_add_berita') }}" method="post" enctype="multipart/form-data">
                      @csrf
                        ...
                        <div class="col-md-6">
                          <div class="form-group md-6">
                            ...
                            <input type="text" class="form-control" name="penulis" id="penulis"
                              placeholder="Enter penulis" required value="{{ old('penulis', 'PPID') }}">
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="tanggal" name="tanggal"
                              placeholder="Enter tanggal" required value="{{ old('tanggal', date('Y-m-d')) }}">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="custom-file">
                          <input type="file" class="custom-file-input fileInput" name="gambar" accept="image/*">
                      ...
                      <div class="form-group">
                        ...
                        <textarea id="tiny" id="isi" name="isi">
                            {{ old('isi') }}
                        </textarea>
                      </div>
                    ...
                    @forelse ($data as $item)
                      <tr>
                        ...
                        <td>
                          ...
                          <form action="{{ route('admin_delete_berita', $item->id) }}" method="POST"
                            class="d-inline">
                            @csrf
                            @method('delete')
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              ...
                              <div class="text-muted mb-3">
                                ...
                                <span>
                                  <i class="fas fa-eye mr-1"></i> {{ $item->view }}x dilihat
                                </span>
                              </div>
                              {!! $item->isi !!}
                            </div>
                      ...
                      {{-- MODAL EDIT BERITA --}}
                      <div id="modalEdit{{ $item->id }}" class="modal fade" tabindex="-1" role="dialog"
                        aria-labelledby="modalEditLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="modalEditLabel">{{ $item->judul }}</h5>
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                  aria-hidden="true">&times;</span></button>
                            </div>

                            <div class="modal-body">
                              <form action="{{ route('admin_update_berita', $item->id) }}" method="post"
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="judul" placeholder="Enter judul"
                                    name="judul" required value="{{ old('judul', $item->judul) }}">
                                </div>
                                ...
                                <div class="form-group">
                                  <label for="gambar">Cover Berita / Informasi</label>
                                  <div class="custom-file">
                                    <input type="file" class="custom-file-input fileInput{{ $item->id }}"
