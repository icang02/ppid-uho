                  ...
                  <tbody>
                    ...
                    @forelse ($data as $item)
                      <tr>
                        ...
                        <td>
                          <img width="120" style="border: 1px solid #c5c5c5" src="{{ asset($item->gambar) }}">
                        </td>
                      </tr>

                      {{-- MODAL EDIT --}}
                      <div id="modalTambah{{ $item->id }}" class="modal fade" tabindex="-1" role="dialog"
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form action="{{ route('admin_laporan_update', $item->id) }}"
                                ...
                                <div class="form-group">
                                  <label for="link">Link Laporan</label>
                                  <input name="link" value="{{ old('link', $item->link) }}" type="text"
                                    class="form-control" id="link" placeholder="Enter link" required>
                                </div>

                                <div class="form-group">
                                  <label for="tahun">Tahun</label>
                                  <input name="tahun" value="{{ old('tahun', $item->tahun) }}" type="number"
                                    class="form-control" id="tahun" placeholder="Enter tahun" required>
                                </div>
