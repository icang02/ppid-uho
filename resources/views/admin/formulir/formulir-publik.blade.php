                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="">Permohonan Informasi Publik</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Penjelasan Permohonan Informasi Publik</h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                    ...
                    <div class="card-header">
                        <h5>Syarat Dan Ketentuan Permohonan Informasi Publik</h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
