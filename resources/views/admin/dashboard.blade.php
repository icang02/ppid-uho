        ...
        <div class="col-md-12 col-xl-4">
          ...
          <div class="card flat-card widget-purple-card">
            <div class="row-table">
              ...
              <div class="col-sm-9">
                <h4>Ke Website</h4>
                <h6 onclick="return window.open('https://ppid.uho.ac.id', '_blank')" style="cursor: pointer">
                  ppid.uho.ac.id</h6>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-12 col-xl-4">
          <div class="card support-bar overflow-hidden">
            <div class="card-body pb-0">
              ...
              <p class="mb-3 mt-3">Informasi yang telah dipublikasikan oleh Pejabat Pengelola Informasi dan Dokumentasi
